  ...
  return (
    ...
    <form className="grid gap-6 mb-6 md:grid-cols-1 w-full" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="grid items-center justify-center text-start">
        <label htmlFor="address" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Your Address:</label>
        <input type="text" className="border-gray-400 border-2 rounded-md" id="address" placeholder="e.g. Paradise Drive 666" {...register("example")} />
      </div>

      <div className="grid items-center justify-center text-start">
        <label htmlFor="postal_code" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Postal Code:</label>
        <input type="text" className="border-gray-400 border-2 rounded-md" id="item_weight" placeholder="e.g. 69420" {...register("example")} />
      </div>

      <label htmlFor="garbage_type" className="block mb-1 text-sm font-medium text-gray-900 dark:text-gray-400">Garbage type:</label>
      ...
      <div className="grid items-center justify-center text-start">
        ...
        <input type="text" className="border-gray-400 border-2 rounded-md" id="item_weight" placeholder="e.g. 200 g" {...register("example")} />
      </div>
      ...
      <div className="grid items-center justify-center text-start">
        ...
        <div className="columns-3 gap-2 grid w-80" style={{ display: 'flex' }}>
          <div>
            ...
            <input type="text" className="border-gray-400 border-2 rounded-md w-24" id="item_height" placeholder="e.g. 20 cm" {...register("example")} />
          </div>
          <div>
            <label htmlFor="item_width" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Width (cm):</label>
            <input type="text" className="border-gray-400 border-2 rounded-md w-24" id="item_width" placeholder="e.g. 20 cm" {...register("example")} />
          </div>
          <div>
            <label htmlFor="item_depth" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Depth (cm):</label>
            <input type="text" className="border-gray-400 border-2 rounded-md w-24" id="item_depth" placeholder="e.g. 20 cm" {...register("example")} />
          </div>
        </div>
      </div>
      ...
      <div className="grid items-center justify-center text-start">
        ...
        <textarea className="border-gray-400 border-2 rounded-md" style={{ resize: 'none ' }} id="item_size" name="item_size" rows="4" cols="50" placeholder={'Write info for our courier here; e.g. how to best enter the building.'}></textarea>
      </div>
